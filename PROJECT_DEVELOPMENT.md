...
当前 `V8.17.1 / 8.17.1.0` 已作为 `.NET 8 / net8.0-windows` 最终基线封存。当前 `Modernized_Working` 后续仅作为 Net8 维护分支使用；Net10 迁移请另开会话、另复制工作区，不要在本目录直接实验。
...
V8.0、V8.2、V8.4、V8.5、V8.6、V8.7、V8.8、V8.10.3、V8.13.3、V8.17.1 已作为里程碑版本封存。Net8 维护请只修改 `Modernized_Working`；Net10 迁移请从 Net8 最终基线复制独立目录。
...
| 后续开发源码 | `E:\采集器\Modernized_Working` | 后续所有代码修改都在这里进行 |
| 当前发布输出 | `E:\采集器\ModernizedOutput` | 后续编译发布会覆盖这里 |
...
| Windows 系统信息 | System.Management `8.0.0` |
