...
public class PinYin
{
	public static string GetFirstLetter(string hz)
	{
		...
		{
			array = FormatText.GetCharset(Configs.BaseConfig.CmsEncoding, "gbk").GetBytes(hz[i].ToString());
			if (array[0] < 176)
			{
				text3 += hz[i];
			}
			...
			{
				text3 += text.Substring(text2.IndexOf(hz[i].ToString(), 0), 1);
			}
		}
	...
	public static string GetCodstring(string UnName)
	{
		...
		byte[] bytes = unicode.GetBytes(UnName);
		...
		while (num < array.Length)
		{
			...
			{
				num2 = (ushort)(array[num] * 256 + array[num + 1]);
				text = ((num2 >= 45217 && num2 <= 45252) ? (text + "A") : ((num2 >= 45253 && num2 <= 45760) ? (text + "B") : ((num2 >= 45761 && num2 <= 46317) ? (text + "C") : ((num2 >= 46318 && num2 <= 46825) ? (text + "D") : ((num2 >= 46826 && num2 <= 47009) ? (text + "E") : ((num2 >= 47010 && num2 <= 47296) ? (text + "F") : ((num2 >= 47297 && num2 <= 47613) ? (text + "G") : ((num2 >= 47614 && num2 <= 48118) ? (text + "H") : ((num2 >= 48119 && num2 <= 49061) ? (text + "J") : ((num2 >= 49062 && num2 <= 49323) ? (text + "K") : ((num2 >= 49324 && num2 <= 49895) ? (text + "L") : ((num2 >= 49896 && num2 <= 50370) ? (text + "M") : ((num2 >= 50371 && num2 <= 50613) ? (text + "N") : ((num2 >= 50614 && num2 <= 50621) ? (text + "O") : ((num2 >= 50622 && num2 <= 50905) ? (text + "P") : ((num2 >= 50906 && num2 <= 51386) ? (text + "Q") : ((num2 >= 51387 && num2 <= 51445) ? (text + "R") : ((num2 >= 51446 && num2 <= 52217) ? (text + "S") : ((num2 >= 52218 && num2 <= 52697) ? (text + "T") : ((num2 >= 52698 && num2 <= 52979) ? (text + "W") : ((num2 >= 52980 && num2 <= 53640) ? (text + "X") : ((num2 >= 53689 && num2 <= 54480) ? (text + "Y") : ((num2 < 54481 || num2 > 55289) ? (text + "_") : (text + "Z"))))))))))))))))))))))));
				num += 2;
			}
		}
		return text.ToLower();
