...
public class ClearCenterPalette3
{
	...
	public ClearCenterPalette3(ArrayList arrayList_0)
	{
		hashtable_0 = new Hashtable();
	...
	private bool method_1(int int_0)
	{
		...
		foreach (int num in waterMarkColors)
		{
			if (num == int_0)
			{
				return true;
	...
	private string[] method_2(BitmapData bitmapData_0, Bitmap bitmap_0, int int_0, int int_1, Rectangle rectangle_0)
	{
	...
	private byte method_3(Color32 color32_0)
	{
		return 0;
	}

	private bool method_4(int int_0, int int_1, int int_2)
	{
	...
	public string[] Quantize(Image image_0)
	{
		...
		try
		{
			...
			return method_2(bitmapData, bitmap2, width, height, rectangle);
		}
		finally
		{
