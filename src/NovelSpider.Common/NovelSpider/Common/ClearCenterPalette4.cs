...
public class ClearCenterPalette4
{
	...
	public ClearCenterPalette4(ArrayList arrayList_0)
	{
		hashtable_0 = new Hashtable();
	...
	private int[] method_2(BitmapData bitmapData_0, Bitmap bitmap_0, int int_0, int int_1, Rectangle rectangle_0)
	{
	...
	private byte sonsOiGak(Color32 color32_0)
	{
		return 0;
	}
}
