...
public class MdiForm : Form
{
	...
	{
		configForm_0.日志记录.SelectedIndex = 4;
		ShowDockContent(configForm_0);
	}
	...
	{
		configForm_0.日志记录.SelectedIndex = 3;
		ShowDockContent(configForm_0);
	}
